  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      <main className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        {/* Left panel - Form */}
        <div className="w-full flex flex-col items-center justify-center p-6 md:p-10 bg-white dark:bg-gray-950 relative">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mt-10 pt-4 border-t border-gray-200 dark:border-gray-800 text-center">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-10">
            <div className="w-full max-w-2xl mx-auto">
              <div className="relative rounded-xl overflow-hidden shadow-2xl">
                <div className="p-4 bg-gray-900/90 backdrop-blur-sm text-white flex items-center space-x-2 border-b border-gray-700">
              ...
              <div className="mt-16 text-white/90">
                <h3 className="text-lg font-medium mb-6">Trusted by teams at</h3>
