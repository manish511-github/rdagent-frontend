  ...
  return (
    <section>
      <div className="border-b">
        <div className="container flex flex-col gap-6 border-x py-4 max-lg:border-x lg:py-8 border-none lg:items-center lg:text-center">
          <FadeIn>
          ...
          <FadeIn delay={0.2}>
            <h2 className="text-3xl leading-tight tracking-tight md:text-4xl lg:text-6xl">Pricing for everyone</h2>
          </FadeIn>
        ...
        <section className="py-14 md:py-20 lg:py-24">
          ...
          <div className="mt-12 overflow-x-auto">
                ...
                {plans.map((plan, index) => (
                  <div key={index} className="flex flex-col p-6">
                    <div className="space-y-2 pb-6">
                      ...
                      {/* Removed the price display from here */}
                    </div>
                    <Button
                      variant={plan.buttonVariant}
                      className={`mt-auto ${
            ...
            {comparisonFeatures.map((category, categoryIndex) => (
              <div key={categoryIndex} className="border-b first:border-t">
                <div className="py-4">
                  <h3 className="text-lg tracking-[-0.36px]">{category.category}</h3>
                </div>
                    ...
                    <div className="col-span-3 grid grid-cols-3 divide-x text-center max-lg:border-t">
                      <div className="flex items-center justify-center py-4">
                        {typeof feature.basic === "boolean" ? (
                          ...
                          <span className="text-muted-foreground-subtle font-semibold">{feature.basic}</span>
                        )}
                      </div>
                      <div className="flex items-center justify-center py-4">
                        {typeof feature.business === "boolean" ? (
                          ...
                          <span className="text-muted-foreground-subtle font-semibold">{feature.business}</span>
                        )}
                      </div>
                      <div className="flex items-center justify-center py-4">
                        {typeof feature.enterprise === "boolean" ? (
                          ...
                          <span className="text-muted-foreground-subtle font-semibold">{feature.enterprise}</span>
                        )}
                      </div>
                    </div>
                  </div>
