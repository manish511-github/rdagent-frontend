  ...
  return (
    <Card className="border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 rounded-none">
      <div className="flex items-center gap-2 mb-3">
        <div className="p-1 bg-blue-50 dark:bg-blue-900/20 rounded-none">
      ...
      <div className="flex flex-wrap gap-1">
        {topics.map((topic, index) => (
          <span
            key={index}
            className="px-2 py-1 text-xs bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-none"
          >
            {topic}
          </span>
        ))}
