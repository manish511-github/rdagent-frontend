...
export default function UpgradePlan({ currentPlan, onPlanSelect, showCurrentPlan = true }: UpgradePlanProps) {
              ...
              return (
                <Card
                  ...
                  className={`w-full rounded-md transition-all duration-200 hover:shadow-lg ${
                    plan.popular ? "shadow-2xl border-primary/20 relative" : "border-border"
